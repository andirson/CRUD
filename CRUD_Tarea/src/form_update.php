...
<?php
	...
	$sql = $databasePDO->query("select id, nombre, apellido, cedula, usuario, estado, rol from tarea_crud");
...
<div class="container">
	...
	<div class="row">
		<div class="col-12">
			<h1>Seleccione usuario a actualizar</h1>
			<br>
			<div>
					...
					<tbody>
						<?php foreach($resultados as $usuarios){ ?>
							<tr>
								...
								<td><a href="<?php echo "update_form.php?id=" . $usuarios->id?>">Actualizar 📝</a></td>
							</tr>
						<?php } ?>
					</tbody>
				</table>
